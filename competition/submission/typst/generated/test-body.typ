...
#figure(
  align(center)[#table(
    ...
    table.header([测试域], [样本或持续时间], [结果], [等级],),
    table.hline(),
...
#figure(
  align(center)[#table(
    ...
    table.header([指标], [shared worst max], [partitioned worst max], [改善], [improved max pairs],),
    table.hline(),
...
#figure(
  align(center)[#table(
    ...
    table.header([指标], [idle 中位数], [CPU stress 中位数], [变化],),
    table.hline(),
...
#figure(
  align(center)[#table(
    columns: (23.08%, 30.77%, 23.08%, 23.08%),
    align: (auto,right,auto,auto,),
    table.header([campaign], [重复次数], [预注册 gate], [关键行为],),
    table.hline(),
...
#figure(
  align(center)[#table(
    ...
    table.header([指标], [manual], [neural], [neural 相对变化], [判定],),
    table.hline(),
...
#figure(
  align(center)[#table(
    columns: 4,
    align: (auto,right,right,right,),
    table.header([延迟段], [median], [p95], [observed max],),
    table.hline(),
...
#figure(
  align(center)[#table(
    ...
    [完整地址], [#link("https://github.com/rcore-os/tgoskits/actions/runs/32794757246");],
...
#figure(
  align(center)[#table(
    columns: (50%, 50%),
    align: (auto,auto,),
    table.header([PR 修复提交], [成果分支 patch-equivalent 提交],),
    table.hline(),
